...
export default function useHomeUser() {
  ...
  // STATE BARU: Pengendali Pop-up Premium Modal Logout User
  ...
  // REVISI: EKSEKUSI LOGOUT PREMIUM TANPA POP-UP JADUL
  ...
  return {
    ...
    layananAktif,
    handleAmbilAntrean,
    handleLogout: triggerLogoutConfirm, // Mengarahkan handleLogout bawaan ke pemicu modal
    handleConfirmLogout,
